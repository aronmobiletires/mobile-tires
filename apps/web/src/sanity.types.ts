...
// Query: {  _id,  _type,  title,  "slug": slug.current,  seo,  pageSettings,  sections[]{    _type,    _key,    _type == "richText" => {      body    },    _type == "heroSection" => {      eyebrow,      headlineMain,      headlineAccent,      body,      trustMarkers[]{ icon, value, label }    },    _type == "trustBar" => {      items[]{ icon, value, label }    },    _type == "servicesSection" => {      eyebrow,      heading,      services[]{        icon,        title,        description,        price,        cta{          label,          linkType,          openInNewTab,          "href": select(            linkType == "external" => externalUrl,            linkType == "internal" => "/" + internalReference->slug.current,            null          )        }      }    },    _type == "howItWorks" => {      eyebrow,      heading,      steps[]{ title, description }    },    _type == "reviewsSection" => {      eyebrow,      heading,      rating,      reviewCount,      quotes[]{ quote, name, city }    },    _type == "coverageSection" => {      eyebrow,      heading,      body,      towns,      areaLabel    },    _type == "depositCallout" => {      eyebrow,      heading,      body,      depositAmount,      depositLabel,      depositNote,      reasons[]{ icon, title, description }    },    _type == "smsBanner" => {      headline,      body,      phoneNumber,      phoneDisplay    },    _type == "tireSizeGuide" => {      eyebrow,      heading,      body,      exampleSize    }  }}
